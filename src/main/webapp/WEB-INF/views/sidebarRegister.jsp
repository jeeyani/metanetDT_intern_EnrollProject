...
<nav id="sidebarMenu"
	...
	<div class="position-sticky pt-3" style="padding:20px;">
		<ul class="nav flex-column">
			...
			<li class="nav-item" style="height:80px"><a class="nav-link" href="<%=application.getContextPath()%>/enrollment"
			...
			<li class="nav-item" style="height:80px"><a class="nav-link" href="<%=application.getContextPath()%>/timetable"
				style="height: 50px; color: black;"> <svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
			...
			<li class="nav-item" style="height:80px"><a class="nav-link" href="<%=application.getContextPath()%>/lecturePlan"
				style="height: 50px; color: black;"> <svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
